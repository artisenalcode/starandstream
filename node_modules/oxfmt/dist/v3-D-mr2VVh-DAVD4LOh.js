...
var require_node$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		getProxyProcessor() {
			return {
				get(node, prop) {
					...
					else if (prop === "root") return () => node.root().toProxy();return node[prop];
				},
				set(node, prop, value) {
 ...
 /* c8 ignore next 2 */
				...
				if (Array.isArray(value)) fixed[name] = value.map((i) => {
					if (typeof i === "object" && i.toJSON) return i.toJSON(null, inputs);return i;
				});
				...
				get(node, prop) {
					if (prop === "proxyOf") return node;
						...
						return node[prop](...args.map((i) => {
							if (typeof i === "function") return (child, index) => i(child.toProxy(), index);return i;
						}));
					};
					...
					else if (prop === "first" || prop === "last") return node[prop].toProxy();return node[prop];
				},
				set(node, prop, value) {
					if (node[prop] === value) return true;
					node[prop] = value;
...
var require_util$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	function getArg(aArgs, aName, aDefaultValue) {
		...
		else if (arguments.length === 3) return aDefaultValue;throw new Error("\"" + aName + "\" is a required argument.");
	}
...
var require_binary_search = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function recursiveSearch(aLow, aHigh, aNeedle, aHaystack, aCompare, aBias) {
		...
		if (cmp === 0) return mid;
			...
			if (aBias == exports.LEAST_UPPER_BOUND) return aHigh < aHaystack.length ? aHigh : -1;return mid;
		}
...
var require_source_map_consumer = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	IndexedSourceMapConsumer.prototype.sourceContentFor = function IndexedSourceMapConsumer_sourceContentFor(aSource, nullOnMissing) {
		...
		if (nullOnMissing) return null;throw new Error("\"" + aSource + "\" is not in the SourceMap.");
	};
...
var require_previous_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function fromBase64(str) {
		if (Buffer) return Buffer.from(str, "base64").toString();return window.atob(str);
	}
...
var require_fromJSON = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function fromJSON(json, inputs) {
		...
		else if (defaults.type === "atrule") return new AtRule(defaults);throw new Error("Unknown node type: " + json.type);
	}
...
var require_map_generator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var MapGenerator = class {
		...
		generateMap() {
			...
			if (this.isInline()) return [this.css];return [this.css, this.map];
		}
		generateString() {
			this.css = "";
			this.map = new SourceMapGenerator({
		...
		outputFile() {
			...
			else if (this.opts.from) return this.path(this.opts.from);return "to.css";
		}
		path(file) {
		...
		sourcePath(node) {
			...
			else if (this.usesFileUrls) return this.toFileUrl(node.source.input.from);return this.toUrl(this.path(node.source.input.from));
		}
		toBase64(str) {
			if (Buffer) return Buffer.from(str).toString("base64");return window.btoa(unescape(encodeURIComponent(str)));
		}
		toFileUrl(path) {
...
var require_processor$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Processor = class {
		...
		process(css, opts = {}) {
			if (!this.plugins.length && !opts.parser && !opts.stringifier && !opts.syntax) return new NoWorkResult(this, css, opts);return new LazyResult(this, css, opts);
		}
		use(plugin) {
...
var require_container = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function(_Node) {
		...
		_proto.atPosition = function atPosition(line, col) {
			if (this.isAtPosition(line, col)) return this._findChildAtPosition(line, col) || this;return;
		};
...
var require_root = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function(_Container) {
		...
		_proto.error = function error(message, options) {
			if (this._error) return this._error(message, options);return new Error(message);
		};
		_createClass(Root, [{
			key: "errorGenerator",
...
var require_namespace = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function(_Node) {
		...
		_proto.qualifiedName = function qualifiedName(value) {
			if (this.namespace) return this.namespaceString + "|" + value;return value;
		};
		_proto.valueToString = function valueToString() {
...
var require_attribute = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Attribute = /* @__PURE__ */ function(_Namespace) {
		...
		_proto.smartQuoteMark = function smartQuoteMark(options) {
			...
			else if (numDoubleQuotes < numSingleQuotes) return Attribute.DOUBLE_QUOTE;return Attribute.SINGLE_QUOTE;
		};
...
var require_parser$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function() {
		...
		_proto.lossySpace = function lossySpace(space, required) {
			if (this.options.lossy) return required ? " " : "";return space;
		};
		_proto.parseParenthesisToken = function parseParenthesisToken(token) {
			var content = this.content(token);
			if (token[_tokenize.FIELDS.TYPE] === tokens.space) return this.requiredSpace(content);return content;
		};
...
var require_processor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function() {
		...
		_proto._shouldUpdateSelector = function _shouldUpdateSelector(rule, options) {
			if (options === void 0) options = {};
			if (Object.assign({}, this.options, options).updateSelector === false) return false;return typeof rule !== "string";
		};
		_proto._isLossy = function _isLossy(options) {
			if (options === void 0) options = {};
			if (Object.assign({}, this.options, options).lossless === false) return true;return false;
		};
...
var require_camelcase_css = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const camelCaseCSS = (property) => {
		...
		else if (property.startsWith("-ms-")) return property.substr(1).replace(pattern, callback);return property.replace(pattern, callback);
	};
...
var require_objectifier = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function atRule(node) {
		if (typeof node.nodes === "undefined") return true;return process(node);
	}
