	...
	var Attribute = /* @__PURE__ */ function(_Namespace) {
		...
		**/
		...
		_proto.smartQuoteMark = function smartQuoteMark(options) {
			...
			else if (numDoubleQuotes < numSingleQuotes) return Attribute$1.DOUBLE_QUOTE;return Attribute$1.SINGLE_QUOTE;
		};
...
var require_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Parser = /* @__PURE__ */ function() {
		...
		_proto.lossySpace = function lossySpace(space$1, required) {
			if (this.options.lossy) return required ? " " : "";return space$1;
		};
