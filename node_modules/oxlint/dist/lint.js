...
var require_uri_all = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function compile(schema, root, localRefs, baseId) {
		...
		function localCompile(_schema, _root, localRefs, baseId) {
			...
			var validate;
			try {
				validate = Function("self", "RULES", "formats", "root", "refVal", "defaults", "customRules", "equal", "ucs2length", "ValidationError", "regExp", sourceCode)(self, RULES, formats, root, refVal, defaults, customRules, equal, ucs2length, ValidationError, opts.regExp), refVal[0] = validate;
			} catch (e) {
	...
	module.exports = function generate_pattern(it, $keyword, $ruleType) {
		...
		if ($isData) out += " var " + $valid + " = true; try { " + $valid + " = " + $regExpCode + "(" + $schemaValue + ").test(" + $data + "); } catch(e) { " + $valid + " = false; } if ( ", $isData && (out += " (" + $schemaValue + " !== undefined && typeof " + $schemaValue + " != 'string') || "), out += " !" + $valid + ") {";
		else {
