...
function quansync$1(input, options) {
  ...
  if (typeof input === "function")
    return fromGeneratorFn(input, options);return fromObject(input);
}
quansync$1({
...
function resolveInlineWorkerOption(value) {
	if (typeof value === "string" && value.trim().endsWith("%")) return getWorkersCountByPercentage(value);return Number(value);
}
